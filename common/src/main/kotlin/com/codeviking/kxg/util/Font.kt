...
fun uiFont(family: String, sizeDp: Float, uiDpi: Float, ctx: KxgContext, style: Int = Font.PLAIN, chars: String = Font.STD_CHARS): Font {
...
fun fontShader(font: Font? = null, propsInit: ShaderProps.() -> Unit = { }): BasicShader {
    ...
    generator.injectors += object: GlslGenerator.GlslInjector {
        override fun fsAfterSampling(shaderProps: ShaderProps, text: StringBuilder, ctx: KxgContext) {
...
class Font(val fontProps: FontProps, ctx: KxgContext) :
    ...
    companion object {
        ...
        fun defaultFont(ctx: KxgContext): Font = Font(Font.DEFAULT_FONT_PROPS, ctx)

        private fun getCharMap(fontProps: FontProps, ctx: KxgContext): CharMap {
