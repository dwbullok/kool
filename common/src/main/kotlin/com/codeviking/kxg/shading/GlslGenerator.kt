...
open class GlslGenerator {
    ...
    interface GlslInjector {
        fun vsHeader(text: StringBuilder, ctx: KxgContext) { }
        fun vsStart(shaderProps: ShaderProps, text: StringBuilder, ctx: KxgContext) { }
        fun vsAfterInput(shaderProps: ShaderProps, text: StringBuilder, ctx: KxgContext) { }
        fun vsBeforeProj(shaderProps: ShaderProps, text: StringBuilder, ctx: KxgContext) { }
        fun vsAfterProj(shaderProps: ShaderProps, text: StringBuilder, ctx: KxgContext) { }
        fun vsEnd(shaderProps: ShaderProps, text: StringBuilder, ctx: KxgContext) { }

        fun fsHeader(text: StringBuilder, ctx: KxgContext) { }
        fun fsStart(shaderProps: ShaderProps, text: StringBuilder, ctx: KxgContext) { }
        fun fsAfterInput(shaderProps: ShaderProps, text: StringBuilder, ctx: KxgContext) { }
        fun fsBeforeSampling(shaderProps: ShaderProps, text: StringBuilder, ctx: KxgContext) { }
        fun fsAfterSampling(shaderProps: ShaderProps, text: StringBuilder, ctx: KxgContext) { }
        fun fsEnd(shaderProps: ShaderProps, text: StringBuilder, ctx: KxgContext) { }
    }
    ...
    fun generate(shaderProps: ShaderProps, ctx: KxgContext): Shader.Source {
    ...
    private fun generateVertShader(shaderProps: ShaderProps, ctx: KxgContext): String {
    ...
    private fun generateFragShader(shaderProps: ShaderProps, ctx: KxgContext): String {
        val text = StringBuilder("${ctx.glCapabilities.glslDialect.version}\n")
    ...
    private fun generateVertInputCode(shaderProps: ShaderProps, text: StringBuilder, ctx: KxgContext) {
    ...
    private fun generateVertBodyCode(shaderProps: ShaderProps, text: StringBuilder, ctx: KxgContext) {
        text.append("\nvoid main() {\n")
    ...
    private fun generateFragInputCode(shaderProps: ShaderProps, text: StringBuilder, ctx: KxgContext) {
    ...
    private fun generateFragBodyCode(shaderProps: ShaderProps, text: StringBuilder, ctx: KxgContext) {
        val shadowMap = shaderProps.shadowMap
        if (shadowMap != null) {
