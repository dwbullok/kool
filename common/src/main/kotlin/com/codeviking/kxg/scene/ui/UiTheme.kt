...
open class UiTheme {
    ...
    fun standardFont(uiDpi: Float, ctx: KxgContext): Font =
    ...
    fun titleFont(uiDpi: Float, ctx: KxgContext): Font =
...
fun UiComponent.standardFont(ctx: KxgContext): Font = root.theme.standardFont(dpi, ctx)
fun UiComponent.titleFont(ctx: KxgContext): Font = root.theme.titleFont(dpi, ctx)
