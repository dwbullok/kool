...
open class SphericalInputTransform(name: String? = null) : TransformGroup(name), InputManager.DragHandler {
    ...
    private fun doCamTransform(ctx: KxgContext) {
...
abstract class PanBase {
    abstract fun computePanPoint(result: MutableVec3f, scene: Scene, ptrPos: Vec2f, ctx: KxgContext): Boolean
}
...
class CameraOrthogonalPan : PanBase() {
    ...
    override fun computePanPoint(result: MutableVec3f, scene: Scene, ptrPos: Vec2f, ctx: KxgContext): Boolean {
