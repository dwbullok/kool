...
abstract class Node(val name: String? = null) : Disposable {
    ...
    val onPreRender: MutableList<Node.(KxgContext) -> Unit> = mutableListOf()
    val onRender: MutableList<Node.(KxgContext) -> Unit> = mutableListOf()
    val onPostRender: MutableList<Node.(KxgContext) -> Unit> = mutableListOf()
    val onDispose: MutableList<Node.(KxgContext) -> Unit> = mutableListOf()

    val onHoverEnter: MutableList<Node.(InputManager.Pointer, RayTest, KxgContext) -> Unit> = mutableListOf()
    val onHover: MutableList<Node.(InputManager.Pointer, RayTest, KxgContext) -> Unit> = mutableListOf()
    val onHoverExit: MutableList<Node.(InputManager.Pointer, RayTest, KxgContext) -> Unit> = mutableListOf()
     ...
     */
    open fun preRender(ctx: KxgContext) {
     ...
     */
    open fun render(ctx: KxgContext) {
     ...
     */
    open fun postRender(ctx: KxgContext) {
     ...
     */
    protected open fun checkIsVisible(ctx: KxgContext): Boolean {
        if (!isVisible) {
            return false
