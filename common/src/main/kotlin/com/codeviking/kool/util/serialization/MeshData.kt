...
import com.codeviking.koolite.KoolException
import com.codeviking.koolite.scene.Mesh
import com.codeviking.koolite.scene.animation.Armature
import com.codeviking.koolite.scene.animation.Bone
import com.codeviking.koolite.shading.*
import com.codeviking.koolite.util.serialization.MeshData.Companion.ATTRIB_POSITIONS
...
data class MeshData(
    ...
    fun toMesh(model: ModelData? = null, generateNormals: Boolean = true, generateTangents: Boolean = false): Mesh {
        ...
        val meshData = com.codeviking.koolite.scene.MeshData(attribs)
    ...
    private fun buildAramature(meshData: com.codeviking.koolite.scene.MeshData): Armature {
