...
fun createContext(): KxgContext = createContext(Lwjgl3Context.InitProps())

fun createContext(props: Lwjgl3Context.InitProps): KxgContext = DesktopImpl.createContext(props)
...
internal object DesktopImpl {
    ...
    init {
        ...
        // initialize GLFW
        if (!GLFW.glfwInit()) {
            throw KxgException("Unable to initialize GLFW")
        }
    ...
    fun createContext(props: Lwjgl3Context.InitProps): KxgContext {
        synchronized(this) {
            if (ctx == null) {
